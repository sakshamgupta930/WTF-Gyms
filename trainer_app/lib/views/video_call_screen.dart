        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              AppSpacing.v12,
              Obx(() => Text(
                'Duration: ${_formatDuration(_call.durationSec.value)}',
                style: const TextStyle(fontSize: 14, color: AppColors.textSecondaryLight),
              )),
              AppSpacing.v16,
              AppTextField(
                labelText: 'Session Summary & Notes',
                hintText: 'E.g. DK worked on deadlift form, adjusted macros...',
              ...
              PrimaryButton(
                ...
                onPressed: () {
                  _call.endCall(widget.requestId, trainerNotes: _notesController.text);
      ...
      body: SafeArea(
        child: Stack(
          children: [
                                ...
                                : Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        AppSpacing.v12,
                                        Text(
                                          _call.peerState.value == 'idle'
                                              ? 'Waiting for DK to join...'
                                              : 'Reconnecting to DK...',
            ...
            // Call overlay metrics / connection check
            Positioned(
              top: 16,
              left: 16,
              child: Row(
