        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              Get.snackbar(
                'Logs Cleared',
                'In-memory logs have been wiped successfully',
      ...
      child: Column(
        children: [
          ...
          _buildEnvRow('100ms Token Server', 'http://localhost:8080/token',
              active: true),
          Obx(() => _buildEnvRow('Server Status',
              socket.isServerRunning.value ? 'ONLINE' : 'OFFLINE',
              active: socket.isServerRunning.value)),
          Obx(() => _buildEnvRow('Clients Active',
              '${socket.isClientConnected.value ? 1 : 0} member connected',
              active: socket.isClientConnected.value)),
